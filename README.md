...
**Lưu ý**: Trong trường hợp không chạy được, ta có thể phải bấm chuột phải vào Solution, chọn Retarger Solution, lựa chọn
cấu hình phù hợp. Sau đó mới có thể chơi được   
## 2. Mô tả chung
### *Luật chơi*:
